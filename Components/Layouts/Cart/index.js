    ...
    <div className='cart-styles' style={{borderTop:'1px solid silver'}} >
      <Container className='cart-box' fluid="true">
        <Row>
            ...
            <Container className='px-5 black-txt'>
              ...
              return(
                  <Row key={i} className="cart-item mx-0">
                      <Col md={size.width>600?"auto":12} xs={12} className="py-3" >
                          <img src={x.image} width={size.width>600? 150:"100%"} height={"100%"} style={{borderRadius:5, objectFit:'cover'}}  alt="Tour"/>
                      </Col>
                      <Col className={`${size.width>600?"px-4 my-3":"mb-2"}`}  >
                      {size.width>600 &&<div style={{float:'right'}}>
                      ...
                      <div className='fw-500 cart-item-name' style={size.width<600?{fontSize:"15px"}:{fontSize:"25px"}}>
                          {x.name}
                      </div>
                      {x.options.map((y, j)=>{
                      return(
              ...
              <div style={{minHeight:90}}>
                <div className='my-1 mb-5'>
                  ...
                  <Row>
                    ...
                    <Col md={2} xs={12}>
                        <button 
                          className={`btn-custom-2 ${size.width>600?"mx-1":"mt-3"}`} 
                          style={{width:"100%"}}
                  ...
                  <Row className='promo'>
                    ...
                    <Col md={3} xs={6} className='text-end '>
                      ...
                      <div className='remove-promo mt-1' onClick={removePromo}>
                        <CloseCircleOutlined className='mx-1 fs-12' />
          ...
          <Col md={4} className={`pay-screen ${size.width<600?"p-3":"p-5"}`} style={size.width<600?{borderLeftColor:"white"}:{}}> 
            {cart.length>0 && 
            <>  
              {session && 
              <> 
