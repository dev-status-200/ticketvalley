...
const CircleIcons = () => {
  return (
    ...
    <Row className="justify-content-md-center pt-5">
        <Col md="auto" className='mx-4'> <Link href={{pathname:'/search',  query:{destination:"uae", city:"Dubai City", category:'Theme Parks' }}}><img src='/icons/5.png' style={{height:160}} /></Link></Col>
        <Col md="auto" className='mx-4'> <Link href={{pathname:'/search',  query:{destination:"uae", city:"Dubai City", category:'Water Parks' }}}><img src='/icons/3.png' style={{height:160}} /></Link></Col>
